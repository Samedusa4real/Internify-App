...
namespace Forage.Data.Migrations
{
    ...
    [Migration("20231102193508_addedCompanyIndustryFieldTable")]
    partial class addedCompanyIndustryFieldTable
    {
            ...
            modelBuilder.Entity("Forage.Core.Entities.CompanyIndustryField", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(6191));
            ...
            modelBuilder.Entity("Forage.Core.Entities.CourseCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(4842));
            ...
            modelBuilder.Entity("Forage.Core.Entities.CourseLevel", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(5308));
            ...
            modelBuilder.Entity("Forage.Core.Entities.HelpMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(3919));
            ...
            modelBuilder.Entity("Forage.Core.Entities.HelpMessageType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(4449));
            ...
            modelBuilder.Entity("Forage.Core.Entities.Question", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 2, 23, 35, 7, 913, DateTimeKind.Utc).AddTicks(3063));
